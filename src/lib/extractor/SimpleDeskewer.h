...
class SimpleDeskewer
{
public:
	SimpleDeskewer(cimbar::vec_xy image_size={}, unsigned anchor_size=0);
...
template <typename MAT>
inline MAT SimpleDeskewer::deskew(const MAT& img, const Corners& corners)
{
